...

{
...

    {
        ...
        if ($backgroundColor == '') {/*select random color*/
            ...
            $backgroundColor = $this->hexToRGB($colorCode[wp_rand(0, count($colorCode) - 1)]);
        ...
        if (imagejpeg($im, $dir . $fileName, 90)) {/*save image as JPG*/
            ...
            return wp_json_encode(array('status' => TRUE, 'image' => $dir . $fileName));
...

    {
        ...
        if ($noiceLines > 0) {
            ...
            for ($i = 0; $i < $noiceLines; $i++) {
                ...
                imageline($im, wp_rand(0, $imgWidth), wp_rand(0, $imgHeight),


                    wp_rand(0, $imgWidth), wp_rand(0, $imgHeight), $noiceColor);
        ...
        if ($noiceDots > 0) {/* generating the dots randomly in background */
            ...
            for ($i = 0; $i < $noiceDots; $i++) {
                ...
                imagefilledellipse($im, wp_rand(0, $imgWidth),


                    wp_rand(0, $imgHeight), 3, 3, $textColor);
    ...
    protected function random($characters = 6, $letters = '23456789bcdfghjkmnpqrstvwxyz')
    {
        ...
        for ($i = 0; $i < $characters; $i++) {
            ...
            $str .= substr($letters, wp_rand(0, strlen($letters) - 1), 1);
